...
func (p *LIVE) ListStorageSpace(query url.Values, body string) (*ListStorageSpaceResp, int, error) {
	resp := new(ListStorageSpaceResp)
	statesCode, err := p.commonHandlerJson("ListStorageSpace", query, resp, body)
	if err != nil {
		return nil, statesCode, err
	}
	return resp, statesCode, nil
...
func (p *LIVE) DescribeLiveStorageSpaceData(query url.Values, body string) (*DescribeLiveStorageSpaceDataResp, int, error) {
	resp := new(DescribeLiveStorageSpaceDataResp)
	statesCode, err := p.commonHandlerJson("DescribeLiveStorageSpaceData", query, resp, body)
	if err != nil {
		return nil, statesCode, err
	}
	return resp, statesCode, nil
