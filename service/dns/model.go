...
type CreateUserZoneBackupRequest struct {
	ZID *int64 `form:"ZID" json:"ZID,omitempty"`
}

type CreateUserZoneBackupResponse struct {
	BackupTime *string `form:"BackupTime" json:"BackupTime,omitempty"`
}

type DeleteUserZoneBackupRequest struct {
	BackupID *string `form:"BackupID" json:"BackupID,omitempty"`
	ZID      *int64  `form:"ZID" json:"ZID,omitempty"`
}

type ListUserZoneBackupsRequest struct {
	ZID *string `form:"-" json:"-"`
}

type ListUserZoneBackupsResponse struct {
	BackupInfos []BackupInfo `form:"BackupInfos" json:"BackupInfos,omitempty"`
}

type QueryBackupScheduleRequest struct {
	ZID *string `form:"-" json:"-"`
}

type QueryBackupScheduleResponse struct {
	CountLimit *int64 `form:"CountLimit" json:"CountLimit,omitempty"`
	Schedule   *int64 `form:"Schedule" json:"Schedule,omitempty"`
}

type RestoreUserZoneBackupRequest struct {
	BackupID *string `form:"BackupID" json:"BackupID,omitempty"`
	ZID      *int64  `form:"ZID" json:"ZID,omitempty"`
}

type RestoreUserZoneBackupResponse struct {
