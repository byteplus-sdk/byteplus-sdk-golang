...
func (p *Vod) ListFileMetaInfosByFileNames(req *request.VodListFileMetaInfosByFileNamesRequest) (*response.VodListFileMetaInfosByFileNamesResponse, int, error) {
	...
	respBody, status, err := p.Post("ListFileMetaInfosByFileNames", url.Values{}, form)

	output := &response.VodListFileMetaInfosByFileNamesResponse{}
 ...
 * @return *response.VodGetFileInfosResponse, int, error
 */
func (p *Vod) GetFileInfos(req *request.VodGetFileInfosRequest) (*response.VodGetFileInfosResponse, int, error) {
	query := url.Values{}
	form := url.Values{}
	marshaler := protojson.MarshalOptions{
		Multiline:       false,
	...
	respBody, status, err := p.Query("GetFileInfos", query)

	output := &response.VodGetFileInfosResponse{}
	unmarshaler := protojson.UnmarshalOptions{
		DiscardUnknown: true,
	}
	errUnmarshal := unmarshaler.Unmarshal(respBody, output)
 ...
 * @return *response.VodDeleteMediaTosFileResponse, int, error
 */
func (p *Vod) DeleteMediaTosFile(req *request.VodDeleteMediaTosFileRequest) (*response.VodDeleteMediaTosFileResponse, int, error) {
	query := url.Values{}
	form := url.Values{}
	marshaler := protojson.MarshalOptions{
		Multiline:       false,
	...
	respBody, status, err := p.Post("DeleteMediaTosFile", url.Values{}, form)

	output := &response.VodDeleteMediaTosFileResponse{}
	unmarshaler := protojson.UnmarshalOptions{
		DiscardUnknown: true,
	}
	errUnmarshal := unmarshaler.Unmarshal(respBody, output)
